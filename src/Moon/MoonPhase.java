//Taken from: https://code.google.com/p/moonphase/source/browse/trunk/Moon/MoonPhase.java?r=12
package Moon;
...
//    double factor; // Moon phase factor
    ...
    public String getMoonAgeAsDays_str() {
    ...
    public double getMoonAgeAsDays() {
